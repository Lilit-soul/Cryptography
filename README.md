...
│   ├── caesar.cpp                   # Шифр Цезаря (симметричный)
│   ├── shamir.cpp                   # Шифр Шамира (3-проходный протокол)
│   ├── elgamal.cpp                  # Эль-Гамаль (асимметричный)
│   └── diffi-helman.cpp             # Диффи-Хеллман (обмен ключами)
│
│
